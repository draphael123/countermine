...
export const ENEMIES = {
  starveling: {
    id: 'starveling', name: 'Feral Levy', short: 'LVY',
    hp: 9, mov: 5, armor: 0, range: 1, atk: [3, 5], abilities: [], threat: 1,
    blurb: 'Conscripted at pike-point, deserted at the first chance, and went feral instead of home.',
  },
  trencher: {
    id: 'trencher', name: 'Pike Warden', short: 'PKW',
    hp: 22, mov: 3, armor: 3, range: 2, minRange: 1, atk: [6, 9], abilities: [], threat: 3,
    blurb: 'Holds the general\u2019s toll-road the way he once held a real line.',
  },
  arbalest: {
    id: 'arbalest', name: 'Poacher', short: 'PCH',
    hp: 14, mov: 2, armor: 0, range: 7, minRange: 2, atk: [6, 8],
    abilities: ['e_volley'], threat: 3,
    blurb: 'Took the king\u2019s deer for years. Takes the king\u2019s soldiers now.',
  },
  ironhusk: {
    id: 'ironhusk', name: 'Rusted Knight', short: 'RKN',
    hp: 34, mov: 2, armor: 4, range: 1, atk: [7, 10],
    abilities: ['e_smash'], threat: 5,
    blurb: 'Errant, oathless, and sealed into plate that has not come off since the armistice.',
  },
  hound: {
    id: 'hound', name: 'Wolfhound', short: 'WLF',
    hp: 13, mov: 4, armor: 0, range: 1, atk: [5, 8],
    abilities: ['e_leap'], threat: 3,
    blurb: 'The general\u2019s kennels went hungry. They opened the gates rather than feed them.',
  },
  bellman: {
    id: 'bellman', name: 'Horn Bearer', short: 'HRN',
    hp: 16, mov: 3, armor: 1, range: 1, atk: [3, 5],
    abilities: ['e_goad'], threat: 4,
    blurb: 'Carries the muster-horn from the old war. Nobody told him the muster ended.',
  },
  lobber: {
    id: 'lobber', name: 'Pitch Lobber', short: 'LOB',
    hp: 12, mov: 2, armor: 0, range: 2, minRange: 1, atk: [3, 5],
    abilities: ['e_lob'], threat: 4,
    blurb: 'Still has pots left from the siege trains. Does not aim at anyone in particular -- at everyone.',
  },
  chanter: {
    id: 'chanter', name: 'Moss Chanter', short: 'CHT',
    hp: 14, mov: 3, armor: 0, range: 2, minRange: 1, atk: [3, 5],
    abilities: ['e_mend'], threat: 4,
    blurb: 'Sings the wounded back onto their feet with the old work-songs. Kill the song first.',
  },
  pyreling: {
    id: 'pyreling', name: 'Tinder Husk', short: 'TDR',
    hp: 8, mov: 4, armor: 0, range: 1, atk: [3, 5],
    abilities: [], threat: 2, explode: [6, 9],
    blurb: 'Packed with the general\u2019s signal-powder. It goes off.',
  },
  drowned: {
    id: 'drowned', name: 'Mire-Sodden', short: 'MIR',
    hp: 20, mov: 3, armor: 1, range: 1, atk: [5, 8],
    abilities: ['e_drag'], threat: 4,
    blurb: 'Went into the bogs to dodge the levy. Came back out wrong.',
  },
};

export const BOSSES = {
  // Captains: each holds one map of the Greenmarch, each with one trick.
  verderer: {
    id: 'verderer', name: 'THE VERDERER', short: 'VRD', boss: true,
    hp: 64, mov: 3, armor: 1, range: 6, minRange: 2, atk: [7, 10],
    abilities: ['e_volley'], threat: 10, quarry: true,
    blurb: 'The general\u2019s huntsman. Every turn he marks a QUARRY \u2014 everything his people do lands 3 harder on the marked.',
  },
  bailiff: {
    id: 'bailiff', name: 'THE BAILIFF OF CHAINS', short: 'BLF', boss: true,
    hp: 78, mov: 3, armor: 2, range: 2, minRange: 1, atk: [8, 11],
    abilities: ['e_drag', 'e_goad'], threat: 12, cage: true,
    blurb: 'Keeps the general\u2019s prisons. Brings a CAGED prisoner to the field as a shield \u2014 break the cage and they fight for you.',
  },
  hornreeve: {
    id: 'hornreeve', name: 'THE HORN-REEVE', short: 'HRV', boss: true,
    hp: 86, mov: 3, armor: 2, range: 1, atk: [9, 12],
    abilities: ['e_smash'], threat: 14, horncall: true,
    blurb: 'Burned the clearings behind him. Every second round the HORN sounds and all his men surge a tile further.',
  },
  aldergrave: {
    id: 'aldergrave', name: 'GENERAL ALDERGRAVE', short: 'GEN', boss: true,
    hp: 118, mov: 3, armor: 3, range: 2, minRange: 1, atk: [10, 14],
    abilities: ['e_breach', 'e_goad'], threat: 20,
    blurb: 'First of the six who never signed. His RIDE comes down a whole lane \u2014 through soldiers, barricades, and the palisade itself.',
  },
};
...
export const RELICS = [
  ...
  { id: 'oil', name: 'Oil-Soaked Rags', cost: 110, locked: true, boss: 'verderer',
    text: 'Your attacks set the target burning: 3 damage a turn for 2 turns.' },
  { id: 'charts', name: 'Countermine Charts', cost: 90, locked: true, boss: 'aldergrave',
    text: 'Camps also patch every unit for 6, and vendor prices drop by a fifth.' },
  { id: 'reliquary', name: 'Cracked Reliquary', cost: 140, locked: true, boss: 'bailiff',
    text: 'The first of yours to fall each battle bursts for 10 to everything adjacent.' },
  { id: 'sallyport', name: 'Sallyport Key', cost: 100, locked: true, boss: 'verderer',
    text: 'Deploy one column further forward.' },
  { id: 'grudge', name: 'Pikemans Grudge', cost: 100, locked: true, boss: 'hornreeve',
    text: 'Attacks made at range 2 or more deal +3.' },
  { id: 'ironrations', name: 'Cold Iron Rations', cost: 120, locked: true, boss: 'aldergrave',
...
export const FLOORS = [
  {
    n: 1, name: 'THE EAVES', sub: 'Where the Greenmarch road goes under the trees.',
    palette: { floor: '#4a5a38', wall: '#3a4a2c', accent: '#c9a84a', ground: 'grass', wallStyle: 'thicket' },
    pool: ['starveling', 'starveling', 'trencher', 'arbalest', 'hound', 'pyreling'],
    elitePool: ['ironhusk', 'bellman'],
    budget: [7, 11], eliteBudget: 13, boss: 'verderer', gold: [45, 70],
  },
  {
    n: 2, name: 'THE DEEP RIDES', sub: 'Old hunting lanes. The cages hang where the light fails.',
    palette: { floor: '#3d5040', wall: '#2c3d30', accent: '#6aa06a', ground: 'grass', wallStyle: 'thicket' },
    pool: ['starveling', 'trencher', 'arbalest', 'hound', 'drowned', 'bellman', 'lobber', 'chanter'],
    elitePool: ['ironhusk', 'drowned', 'lobber'],
    budget: [11, 15], eliteBudget: 17, boss: 'bailiff', gold: [55, 80],
  },
  {
    n: 3, name: 'THE BURNED CLEARINGS', sub: 'He fires the villages that will not feed his men.',
    palette: { floor: '#5a5038', wall: '#443a28', accent: '#d08a3c', ground: 'scorch', wallStyle: 'thicket' },
    pool: ['starveling', 'trencher', 'arbalest', 'hound', 'drowned', 'bellman', 'lobber', 'chanter', 'pyreling'],
    elitePool: ['ironhusk', 'bellman', 'lobber'],
    budget: [14, 19], eliteBudget: 21, boss: 'hornreeve', gold: [65, 95],
  },
  {
    n: 4, name: 'THE GENERAL\u2019S COURT', sub: 'A palisade of whole oaks. He calls it a province.',
    palette: { floor: '#4a5533', wall: '#35432a', accent: '#d4b040', ground: 'grass', wallStyle: 'thicket' },
    pool: ['trencher', 'arbalest', 'hound', 'bellman', 'ironhusk', 'lobber', 'chanter', 'pyreling'],
    elitePool: ['ironhusk', 'ironhusk', 'chanter'],
    budget: [17, 22], eliteBudget: 24, boss: 'aldergrave', gold: [80, 120],
  },
];
